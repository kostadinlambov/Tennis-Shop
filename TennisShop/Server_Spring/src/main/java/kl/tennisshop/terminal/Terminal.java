package kl.tennisshop.terminal;


import kl.tennisshop.CommandFactory;
import kl.tennisshop.command.Executable;
...
//        Role fetchedRole1 = this.roleService.getByName("User");
//        Role fetchedRole2 = this.roleService.getByName("Admin");
...
//        System.out.println(userDto1.getRoles().size());
//
//        // Get User By ID
...
////        category.setName("Tennis Rackets");
//
...
//            System.out.println("Name: " + racket.getName());
//       }
...
////        System.out.println(racket1.getName());
////        System.out.println(racket2.getName());
////
...
////            System.out.println("SavedOrder Racket name: " + racket.getName());
////        }
...
//        }
        ...
        String[] newUserParams =  new String[]{
                "Gosho", "Goshev",  "gosho@abv.bg", "1111", "1111", "Vasil Levski 20", "Sofia"
        };

...
public class ApplicationSecurityConfiguration
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers( "/rackets/details", "/rackets/create", "/rackets/edit", "/rackets/delete", "/users/all", "/users/promote", "/users/demote").hasAnyAuthority("ADMIN", "ROOT")
                .antMatchers("/users/my").hasAuthority("ROOT")
